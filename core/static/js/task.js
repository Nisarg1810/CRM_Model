...
class TaskManager {
    ...
    setupMarketingTaskToggle() {
        ...
        if (marketingTaskToggle && marketingTaskLabel) {
            const self = this;
            marketingTaskToggle.addEventListener('change', function() {
                if (this.checked) {
                    this.value = 'true';
                    ...
                    self.showMarketingEmployeeOption();
                } else {
                    this.value = 'false';
                    ...
                    self.hideMarketingEmployeeOption();
                }
            });
        ...
        // Setup Edit Marketing Task toggle
        this.setupEditMarketingTaskToggle();
    }
    ...
    setupEditMarketingTaskToggle() {
        const editMarketingTaskToggle = document.getElementById('editMarketingTask');
        const editMarketingTaskLabel = document.getElementById('editMarketingTaskLabel');
        
        if (editMarketingTaskToggle && editMarketingTaskLabel) {
            editMarketingTaskToggle.addEventListener('change', function() {
                if (this.checked) {
                    this.value = 'true';
                    editMarketingTaskLabel.textContent = 'Yes';
                    editMarketingTaskLabel.classList.add('text-success');
                    editMarketingTaskLabel.classList.remove('text-muted');
                } else {
                    this.value = 'false';
                    editMarketingTaskLabel.textContent = 'No';
                    editMarketingTaskLabel.classList.add('text-muted');
                    editMarketingTaskLabel.classList.remove('text-success');
                }
            });
        }
...
function editTask(taskId) {
    ...
    .then(data => {
        ...
        if (data.success) {
            ...
            // Populate Marketing Task toggle
            const editMarketingTaskToggle = document.getElementById('editMarketingTask');
            const editMarketingTaskLabel = document.getElementById('editMarketingTaskLabel');
            if (editMarketingTaskToggle && editMarketingTaskLabel) {
                const isMarketingTask = data.task.marketing_task || false;
                editMarketingTaskToggle.checked = isMarketingTask;
                editMarketingTaskToggle.value = isMarketingTask.toString();
                if (isMarketingTask) {
                    editMarketingTaskLabel.textContent = 'Yes';
                    editMarketingTaskLabel.classList.add('text-success');
                    editMarketingTaskLabel.classList.remove('text-muted');
...
function submitNewEmployee() {
    ...
    const requiredFields = ['username', 'full_name', 'email', 'role', 'employee_type', 'password'];
